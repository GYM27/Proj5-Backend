...
` +
    ...
    if (vn) {
      ...
      j = yr && (!document.documentMode || 9 < document.documentMode);
    }
    function Sr() {
      hr && (hr.detachEvent(`onpropertychange`, Cr), (A = hr = null));
    }
    function Cr(e) {
      if (e.propertyName === `value` && _r(A)) {
        var t = [];
        (mr(t, A, e, dn(e)), gn(gr, t));
      }
    }
    function wr(e, t, n) {
      e === `focusin`
        ? (Sr(), (hr = t), (A = n), hr.attachEvent(`onpropertychange`, Cr))
        : e === `focusout` && Sr();
    }
    function Tr(e) {
    ...
    function Ms(e, t, n) {
      ...
      ((n = {
        ...
        Is(e)
          ? Ls(t, n)
          : ((n = li(e, t, n, r)), n !== null && (hu(n, e, r), Rs(n, t, r))));
    }
    function Ns(e, t, n) {
      Ps(e, t, n, pu());
    }
      ...
      if (o !== null) {
        ...
        if ((co(t), a))
          ...
          if (
            ...
            throw ((o.retryLane = s), ui(e, s), hu(r, e, s), rc);
          (Du(), (t = pc(e, t, n)));
        } else
          ((e = o.treeContext),
            (N = cf(s.nextSibling)),
    ...
    function vc(e, t, n, r, i) {
      if ((aa(t), t.stateNode === null)) {
        ...
        (typeof o == `object` && o && (a = F(o)),
          ...
          Ua(t),
          (o = n.contextType),
          (a.context = typeof o == `object` && o ? F(o) : pi),
          (a.state = t.memoizedState),
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (
            ...
            throw ((l.retryLane = r), ui(e, r), hu(s, e, r), rc);
          (af(c) || Du(), (t = Ec(e, t, n)));
        } else
          af(c)
...
var Ue = _.createContext(!1),
  We = _.createContext({ isTransitioning: !1 });
We.displayName = `ViewTransition`;
var Ge = _.createContext(new Map());
...
var Je = _.createContext({ outlet: null, matches: [], isDataRoute: !1 });
...
function ot() {
  let { isDataRoute: e } = _.useContext(Je);
  return e ? kt() : st();
}
function st() {
  w(
...
function lt(e) {
  let t = _.useContext(Je).outlet;
  return _.useMemo(
    () => t && _.createElement(ct.Provider, { value: e }, t),
    [t, e],
  );
}
function ut(e, { relative: t } = {}) {
  let { matches: n } = _.useContext(Je),
    { pathname: r } = rt(),
    i = JSON.stringify(Ae(n));
  return _.useMemo(() => je(e, JSON.parse(i), r, t === `path`), [e, i, r, t]);
}
function dt(e, t) {
  return ft(e, t);
}
...
var mt = _.createElement(pt, null),
  ht = class extends _.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e === void 0
          ...
          : _.createElement(
              ...
              _.createElement(Ye.Provider, {
                value: e,
                children: this.props.component,
              }),
            );
      return this.context ? _.createElement(_t, { error: e }, t) : t;
    }
  };
ht.contextType = Ue;
var gt = new WeakMap();
...
function vt({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    _.createElement(Je.Provider, { value: e }, n)
  );
}
function yt(e, t = [], n) {
  let r = n?.state;
...
(_.useOptimistic, _.memo(Mt));
function Mt({ routes: e, future: t, state: n, isStatic: r, onError: i }) {
  return ft(e, void 0, { state: n, isStatic: r, onError: i, future: t });
}
function Nt({ to: e, replace: t, state: n, relative: r }) {
  w(
    nt(),
    `<Navigate> may be used only in the context of a <Router> component.`,
  );
  let { static: i } = _.useContext(k);
  T(
    !i,
    `<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`,
  );
  let { matches: a } = _.useContext(Je),
    { pathname: o } = rt(),
    s = ot(),
    c = je(e, Ae(a), o, r === `path`),
    l = JSON.stringify(c);
  return (
    _.useEffect(() => {
  ...
  return (
    ...
    h == null
      ...
      : _.createElement(
          k.Provider,
          { value: c },
          _.createElement(qe.Provider, { children: t, value: h }),
        )
  );
}
...
function yn({ page: e, ...t }) {
  let { router: n } = pn(),
    r = _.useMemo(() => ce(n.routes, e, n.basename), [n.routes, e, n.basename]);
  return r ? _.createElement(xn, { page: e, matches: r, ...t }) : null;
}
function bn(e) {
...
function xn({ page: e, matches: t, ...n }) {
  let r = rt(),
    ...
    u = _.useMemo(() => cn(e, t, l, a, r, `data`), [e, t, l, a, r]),
    d = _.useMemo(() => cn(e, t, l, a, r, `assets`), [e, t, l, a, r]),
    f = _.useMemo(() => {
...
var Cn =
  ...
  window.document.createElement !== void 0;
try {
  Cn && (window.__reactRouterVersion = `7.13.1`);
} catch {}
function wn({
  basename: e,
  children: t,
...
var En = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Dn = _.forwardRef(function (
    ...
    let {
      ...
      y = typeof l == `string` && En.test(l),
      b = Be(l, h);
    l = b.to;
    let x = tt(l, { relative: r }),
      ee = rt(),
      S = null;
    if (o) {
    ...
    return C && !y
      ? _.createElement(_.Fragment, null, ie, _.createElement(yn, { page: x }))
      : ie;
  });
Dn.displayName = `Link`;
var On = _.forwardRef(function (
  {
    "aria-current": e = `page`,
    caseSensitive: t = !1,
    className: n = ``,
...
var kn = _.forwardRef(
  (
    ...
    let { unstable_useTransitions: h } = _.useContext(k),
      g = Ln(),
      v = Rn(s, { relative: l }),
      y = o.toLowerCase() === `get` ? `get` : `post`,
      b = typeof s == `string` && En.test(s);
...
function An({ getKey: e, storageKey: t, ...n }) {
  ...
  return _.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${en(JSON.stringify(t || zn))}, ${en(JSON.stringify(s))})`,
    },
  });
}
...
var Qn = (e) => (t) => {
  ...
  $n = Xn(
    ((e, t) => (n, r, i) => {
      let a = {
          storage: Zn(() => window.localStorage),
          partialize: (e) => e,
          version: 0,
          merge: (e, t) => ({ ...t, ...e }),
          ...t,
      ...
      let m,
        h = () => {
          ...
          return Qn(u.getItem.bind(u))(a.name)
            .then((e) => {
              if (e)
    ...
    })((e) => ({ username: ``, updateName: (t) => e({ username: t }) }), {
      name: `user-storage`,
      storage: Zn(() => sessionStorage),
    }),
  ),
  er = `http://localhost:8080/LuisF-proj5/rest/users/login`,
  tr = async (e) => {
    try {
      let t = await fetch(er, {
        method: `POST`,
      ...
      let n = t.headers.get(`token`),
        r = await t.json();
      return { ...r, token: n || r.token };
    } catch (e) {
      throw (
        console.error(`Erro na chamada de Login:`, e.message),
...
function lr(e, t) {
  return Object.keys(t).reduce(function (n, r) {
    var i,
      ...
      o = a[ar(r)],
      s = a[r],
      c = ir(a, [ar(r), r].map(or)),
      l = t[r],
      u = cr(s, o, e[l]),
      d = u[0],
      f = u[1];
    return rr({}, c, ((i = {}), (i[r] = d), (i[l] = f), i));
  }, e);
}
function ur(e, t) {
  return (
...
var hr = o((e) => {
  ...
  { Consumer: _r, Provider: vr } = gr;
function j(e, t) {
  let { prefixes: n } = (0, _.useContext)(gr);
  return e || n[t] || t;
}
function yr() {
  let { breakpoints: e } = (0, _.useContext)(gr);
  return e;
}
function br() {
  let { minBreakpoint: e } = (0, _.useContext)(gr);
  return e;
}
function xr(e) {
...
function Cr(e, t) {
  return Sr(e).getComputedStyle(e, t);
}
var wr = /([A-Z])/g;
function Tr(e) {
  return e.replace(wr, `-$1`).toLowerCase();
}
var Er = /^ms-/;
function Dr(e) {
  return Tr(e).replace(Er, `-ms-`);
}
var Or =
...
function Ar(e, t) {
  var n = ``,
    r = ``;
  if (typeof t == `string`)
    return e.style.getPropertyValue(Dr(t)) || Cr(e).getPropertyValue(Dr(t));
  (Object.keys(t).forEach(function (i) {
    var a = t[i];
    !a && a !== 0
      ? e.style.removeProperty(Dr(i))
      : kr(i)
        ? (r += i + `(` + a + `) `)
        : (n += Dr(i) + `: ` + a + `;`);
  }),
  ...
  Ur = (function (e) {
    ...
    function t(t, n) {
      ...
      return (
        ...
        t.in
          ? a
            ? ((o = zr), (r.appearStatus = Br))
            : (o = Vr)
          : (o = t.unmountOnExit || t.mountOnEnter ? Rr : zr),
        (r.state = { status: o }),
        (r.nextCallback = null),
        r
      );
    ...
    t.getDerivedStateFromProps = function (e, t) {
      return e.in && t.status === `unmounted` ? { status: zr } : null;
    };
    var n = t.prototype;
    return (
      ...
      (n.componentDidUpdate = function (e) {
        ...
        if (e !== this.props) {
          ...
          this.props.in
            ? n !== `entering` && n !== `entered` && (t = Br)
            : (n === `entering` || n === `entered`) && (t = Hr);
        }
      ...
      (n.performEnter = function (e) {
        var t = this,
          ...
          i = this.props.nodeRef ? [r] : [Lr.default.findDOMNode(this), r],
          a = i[0],
          o = i[1],
          s = this.getTimeouts(),
      ...
      (n.performExit = function () {
        var e = this,
          t = this.props.exit,
          n = this.getTimeouts(),
          r = this.props.nodeRef ? void 0 : Lr.default.findDOMNode(this);
        if (!t || Pr.disabled) {
...
((Ur.contextType = Fr), (Ur.propTypes = {}));
function Wr() {}
((Ur.defaultProps = {
  in: !1,
  mountOnEnter: !1,
...
function ai(e, t) {
  let n = ri(
    ...
    ii(e, `transitionDuration`) + ii(e, `transitionDelay`),
  );
}
function oi(e) {
  e.offsetHeight;
...
function li(e, t) {
  return (0, _.useMemo)(() => ci(e, t), [e, t]);
}
function ui(e) {
  return e && `setState` in e ? Lr.default.findDOMNode(e) : (e ?? null);
}
var di = _.forwardRef(
  (
    {
...
di.displayName = `TransitionWrapper`;
function fi(e) {
  let t = (0, _.useRef)(e);
  return (
    (0, _.useEffect)(() => {
  ...
  mi = (e) =>
    _.forwardRef((t, n) =>
      (0, A.jsx)(`div`, {
        ...t,
        ref: n,
        className: (0, M.default)(t.className, e),
      }),
    ),
  hi = mi(`h4`);
hi.displayName = `DivStyledAsH4`;
var gi = _.forwardRef(
  ({ className: e, bsPrefix: t, as: n = hi, ...r }, i) => (
    (t = j(t, `alert-heading`)),
    (0, A.jsx)(n, { ref: i, className: (0, M.default)(e, t), ...r })
  ),
);
gi.displayName = `AlertHeading`;
function _i(e) {
  let t = (0, _.useRef)(e);
  return (
    (0, _.useEffect)(() => {
...
typeof global < `u` && global.navigator && global.navigator.product;
var yi = [`as`, `disabled`];
function bi(e, t) {
  if (e == null) return {};
  var n = {};
...
function Si({
  ...
  let u = (r) => {
      if (((t || (e === `a` && xi(n))) && r.preventDefault(), t)) {
        r.stopPropagation();
        return;
      }
      o?.(r);
...
var Ci = _.forwardRef((e, t) => {
  let { as: n, disabled: r } = e,
    i = bi(e, yi),
    [a, { tagName: o }] = Si(Object.assign({ tagName: n, disabled: r }, i));
...
var Di = _.forwardRef((e, t) => {
  let { onKeyDown: n } = e,
    r = Ti(e, wi),
    [i] = Si(Object.assign({ tagName: `a` }, r)),
    a = vi((e) => {
      (i.onKeyDown(e), n?.(e));
    });
  return Ei(r.href) || r.role === `button`
    ? (0, A.jsx)(`a`, Object.assign({ ref: t }, r, i, { onKeyDown: a }))
    : (0, A.jsx)(`a`, Object.assign({ ref: t }, r, { onKeyDown: n }));
});
Di.displayName = `Anchor`;
var Oi = _.forwardRef(
...
Oi.displayName = `AlertLink`;
var ki = { [Br]: `show`, [Vr]: `show` },
  Ai = _.forwardRef(
    (
      {
        className: e,
...
var ji = c(Nr()),
  Mi = {
    "aria-label": ji.default.string,
    onClick: ji.default.func,
    variant: ji.default.oneOf([`white`]),
  },
  Ni = _.forwardRef(
    ({ className: e, variant: t, "aria-label": n = `Close`, ...r }, i) =>
      (0, A.jsx)(`button`, {
        ref: i,
        type: `button`,
        className: (0, M.default)(`btn-close`, t && `btn-close-${t}`, e),
        "aria-label": n,
        ...r,
      }),
  );
((Ni.displayName = `CloseButton`), (Ni.propTypes = Mi));
var Pi = _.forwardRef((e, t) => {
  let {
      bsPrefix: n,
      show: r = !0,
    ...
    g = (0, A.jsxs)(`div`, {
      ...
      children: [
        u && (0, A.jsx)(Ni, { onClick: m, "aria-label": i, variant: a }),
        s,
      ],
    });
  return h
...
Pi.displayName = `Alert`;
var Fi = Object.assign(Pi, { Link: Oi, Heading: gi }),
  Ii = _.forwardRef(
    (
      {
        as: e,
      ...
      let l = j(t, `btn`),
        [u, { tagName: d }] = Si({ tagName: e, disabled: a, ...s });
      return (0, A.jsx)(d, {
        ...u,
        ...s,
        ref: c,
...
Ri.displayName = `CardFooter`;
var zi = _.createContext(null);
zi.displayName = `CardHeaderContext`;
var N = _.forwardRef(
  ({ bsPrefix: e, className: t, as: n = `div`, ...r }, i) => {
    let a = j(e, `card-header`),
      o = (0, _.useMemo)(() => ({ cardHeaderBsPrefix: a }), [a]);
    return (0, A.jsx)(zi.Provider, {
      value: o,
      children: (0, A.jsx)(n, {
        ref: i,
        ...r,
        className: (0, M.default)(t, a),
      }),
    });
  },
);
...
var P = _.forwardRef(
  ({ bsPrefix: e, className: t, variant: n, as: r = `img`, ...i }, a) => {
    ...
    return (0, A.jsx)(r, {
      ref: a,
      className: (0, M.default)(n ? `${o}-${n}` : o, t),
      ...i,
    });
  },
);
...
Wi.displayName = `CardText`;
var Gi = mi(`h5`),
  Ki = _.forwardRef(
    ({ className: e, bsPrefix: t, as: n = Gi, ...r }, i) => (
      (t = j(t, `card-title`)),
      (0, A.jsx)(n, { ref: i, className: (0, M.default)(e, t), ...r })
    ),
  );
...
var qi = _.forwardRef(
  (
    ...
    return (0, A.jsx)(s, {
      ...
      children: a ? (0, A.jsx)(Li, { children: o }) : o,
    });
  },
);
qi.displayName = `Card`;
var Ji = Object.assign(qi, {
  Img: P,
  Title: Ki,
  Subtitle: Ui,
  Body: Li,
...
function Xi({ as: e, bsPrefix: t, className: n, ...r }) {
  t = j(t, `col`);
  let i = yr(),
    a = br(),
    o = [],
  ...
  return (
    ...
    [
      { ...r, className: (0, M.default)(n, ...o, ...s) },
      { as: e, bsPrefix: t, spans: o },
    ]
  );
}
var Zi = _.forwardRef((e, t) => {
  let [{ className: n, ...r }, { as: i = `div`, bsPrefix: a, spans: o }] =
    Xi(e);
  return (0, A.jsx)(i, {
    ...r,
    ref: t,
    className: (0, M.default)(n, !o.length && a),
  });
});
Zi.displayName = `Col`;
var Qi = _.forwardRef(
  ({ bsPrefix: e, fluid: t = !1, as: n = `div`, className: r, ...i }, a) => {
    ...
    return (0, A.jsx)(n, {
      ref: a,
      ...i,
      className: (0, M.default)(r, t ? `${o}${s}` : o),
    });
  },
);
Qi.displayName = `Container`;
var $i = o((e, t) => {
    var n = !1,
      r = function () {};
    if (n) {
  ...
  ea = {
    type: ji.default.string,
    tooltip: ji.default.bool,
    as: ji.default.elementType,
  },
  ta = _.forwardRef(
    (
      ...
      (0, A.jsx)(e, {
        ...i,
        ref: a,
        className: (0, M.default)(t, `${n}-${r ? `tooltip` : `feedback`}`),
      }),
  );
...
var na = _.createContext({}),
  ra = _.forwardRef(
    (
      ...
      let { controlId: l } = (0, _.useContext)(na);
      return (
        (t = j(t, `form-check-input`)),
        (0, A.jsx)(o, {
          ...s,
          ref: c,
          type: r,
          id: e || l,
          className: (0, M.default)(n, t, i && `is-valid`, a && `is-invalid`),
        })
      );
    },
  );
ra.displayName = `FormCheckInput`;
var ia = _.forwardRef(({ bsPrefix: e, className: t, htmlFor: n, ...r }, i) => {
  let { controlId: a } = (0, _.useContext)(na);
  return (
    (e = j(e, `form-check-label`)),
    (0, A.jsx)(`label`, {
      ...r,
      ref: i,
      htmlFor: n || a,
      className: (0, M.default)(t, e),
    })
  );
});
ia.displayName = `FormCheckLabel`;
var aa = _.forwardRef(
  (
    {
      id: e,
    ...
    let { controlId: x } = (0, _.useContext)(na),
      ee = (0, _.useMemo)(() => ({ controlId: e || x }), [x, e]),
      S = (!g && h != null && h !== !1) || Yi(g, ia),
      C = (0, A.jsx)(ra, {
        ...y,
      ...
      children: (0, A.jsx)(`div`, {
        ...
        children:
          ...
          (0, A.jsxs)(A.Fragment, {
            children: [
              C,
              S && (0, A.jsx)(ia, { title: p, children: h }),
              l && (0, A.jsx)(ta, { type: u, tooltip: c, children: l }),
            ],
          }),
      }),
    });
...
aa.displayName = `FormCheck`;
var F = Object.assign(aa, { Input: ra, Label: ia });
c($i());
var oa = _.forwardRef(
  (
    {
    ...
    let { controlId: p } = (0, _.useContext)(na);
    return (
      (e = j(e, `form-control`)),
      (0, A.jsx)(u, {
        ...d,
...
var sa = Object.assign(oa, { Feedback: ta }),
  ca = _.forwardRef(
    ({ className: e, bsPrefix: t, as: n = `div`, ...r }, i) => (
      (t = j(t, `form-floating`)),
      (0, A.jsx)(n, { ref: i, className: (0, M.default)(e, t), ...r })
...
ca.displayName = `FormFloating`;
var la = _.forwardRef(({ controlId: e, as: t = `div`, ...n }, r) => {
...
var ua = _.forwardRef(
  (
    ...
    let { controlId: c } = (0, _.useContext)(na);
    t = j(t, `form-label`);
    let l = `col-form-label`;
    typeof n == `string` && (l = `${l} ${l}-${n}`);
    let u = (0, M.default)(i, t, r && `visually-hidden`, n && l);
    return (
      (a ||= c),
      n
        ? (0, A.jsx)(Zi, {
...
var I = _.forwardRef(({ bsPrefix: e, className: t, id: n, ...r }, i) => {
  let { controlId: a } = (0, _.useContext)(na);
  return (
    (e = j(e, `form-range`)),
    (0, A.jsx)(`input`, {
...
var fa = _.forwardRef(
  ({ bsPrefix: e, className: t, as: n = `small`, muted: r, ...i }, a) => (
    ...
    (0, A.jsx)(n, {
      ...i,
      ref: a,
      className: (0, M.default)(t, e, r && `text-muted`),
    })
  ),
);
fa.displayName = `FormText`;
var pa = _.forwardRef((e, t) =>
  (0, A.jsx)(F, { ...e, ref: t, type: `switch` }),
);
pa.displayName = `Switch`;
var ma = Object.assign(pa, { Input: F.Input, Label: F.Label }),
  ha = _.forwardRef(
    (
...
ha.displayName = `FloatingLabel`;
var ga = {
    _ref: ji.default.any,
    validated: ji.default.bool,
    as: ji.default.elementType,
  },
  _a = _.forwardRef(({ className: e, validated: t, as: n = `form`, ...r }, i) =>
    (0, A.jsx)(n, {
      ...r,
      ref: i,
      className: (0, M.default)(e, t && `was-validated`),
    }),
  );
((_a.displayName = `Form`), (_a.propTypes = ga));
var L = Object.assign(_a, {
    Group: la,
    Control: sa,
    Floating: ca,
    Check: F,
  ...
  va = _.forwardRef(({ bsPrefix: e, className: t, as: n = `div`, ...r }, i) => {
    let a = j(e, `row`),
      o = yr(),
      s = br(),
      c = `${a}-cols`,
    ...
    return (
      ...
      (0, A.jsx)(n, { ref: i, ...r, className: (0, M.default)(t, a, ...l) })
    );
  });
va.displayName = `Row`;
function ya() {
  let [e, t] = (0, _.useState)({ username: ``, password: `` }),
              ...
              (0, A.jsxs)(L, {
                onSubmit: async (t) => {
                  ...
                  try {
                    ...
                    (t &&
                      ...
                      console.log(`Token guardado com sucesso:`, t.token)),
                      a(t.username || e.username),
                      i(`/Dashboard`, { replace: !0 }));
                  } catch (e) {
                    r(e.message);
                  }
                },
                children: [
                  (0, A.jsxs)(L.Group, {
                    ...
                    children: [
                      (0, A.jsx)(L.Label, { children: `Utilizador` }),
                      (0, A.jsx)(L.Control, {
                        type: `text`,
                        name: `username`,
                  ...
                  (0, A.jsxs)(L.Group, {
                    ...
                    children: [
                      (0, A.jsx)(L.Label, { children: `Palavra-passe` }),
                      (0, A.jsx)(L.Control, {
                        type: `password`,
                        name: `password`,
                  ...
                  (0, A.jsxs)(`div`, {
                    ...
                    children: [
                      (0, A.jsx)(`span`, {
                        ...
                        children: `Ainda não tem conta? `,
                      }),
                      (0, A.jsx)(Dn, {
                        to: `/register`,
                        className: `text-decoration-none fw-bold`,
                        children: `Registe-se aqui`,
                      }),
                    ],
                  }),
                ],
...
var ba = `http://localhost:8080/LuisF-proj5/rest/users/register`,
  xa = async (e) => {
    try {
      let t = await fetch(ba, {
        method: `POST`,
        headers: { "Content-Type": `application/json` },
        body: JSON.stringify(e),
      });
      ...
      if (!t.ok)
        throw t.status === 409
          ? Error(`Este utilizador ou email já está registado.`)
          : Error(
      ...
      throw (
        console.error(`Erro Técnico Oculto:`, e),
        e.message === `Failed to fetch`
          ? Error(
...
function Sa() {
  ...
  return (0, A.jsx)(Qi, {
    className: `d-flex justify-content-center align-items-center vh-100 py-5`,
    children: (0, A.jsx)(Ji, {
      ...
      children: (0, A.jsxs)(Ji.Body, {
        children: [
          ...
          n && (0, A.jsx)(Fi, { variant: `danger`, children: n }),
          (0, A.jsxs)(L, {
            onSubmit: async (t) => {
              (t.preventDefault(), r(null));
              try {
                ...
                r(e.message || `Erro ao criar conta. Tente novamente.`);
              }
            },
            children: [
              (0, A.jsxs)(va, {
                children: [
                  (0, A.jsx)(Zi, {
                    md: 6,
                    children: (0, A.jsxs)(L.Group, {
                      className: `mb-3`,
                      children: [
                        (0, A.jsx)(L.Label, { children: `Primeiro Nome` }),
                        (0, A.jsx)(L.Control, {
                          type: `text`,
                          name: `firstName`,
                          value: e.firstName,
                  ...
                  (0, A.jsx)(Zi, {
                    ...
                    children: (0, A.jsxs)(L.Group, {
                      className: `mb-3`,
                      children: [
                        (0, A.jsx)(L.Label, { children: `Ultimo Nome` }),
                        (0, A.jsx)(L.Control, {
                          type: `text`,
                          name: `lastName`,
                          value: e.lastName,
              ...
              (0, A.jsxs)(L.Group, {
                className: `mb-3`,
                children: [
                  (0, A.jsx)(L.Label, { children: `Username` }),
                  (0, A.jsx)(L.Control, {
                    type: `text`,
                    name: `username`,
                    value: e.username,
              ...
              (0, A.jsxs)(L.Group, {
                className: `mb-3`,
                children: [
                  (0, A.jsx)(L.Label, { children: `Email` }),
                  (0, A.jsx)(L.Control, {
                    type: `email`,
                    name: `email`,
                    value: e.email,
              ...
              (0, A.jsxs)(L.Group, {
                className: `mb-3`,
                children: [
                  (0, A.jsx)(L.Label, { children: `Password` }),
                  (0, A.jsx)(L.Control, {
                    type: `password`,
                    name: `password`,
                    value: e.password,
              ...
              (0, A.jsxs)(L.Group, {
                className: `mb-3`,
                children: [
                  (0, A.jsx)(L.Label, { children: `Contacto Telefónico` }),
                  (0, A.jsx)(L.Control, {
                    type: `tel`,
                    name: `cellphone`,
                    placeholder: `+351`,
              ...
              (0, A.jsxs)(L.Group, {
                className: `mb-4`,
                children: [
                  (0, A.jsx)(L.Label, { children: `URL da Foto de Perfil` }),
                  (0, A.jsx)(L.Control, {
                    type: `text`,
                    name: `photoUrl`,
                    placeholder: `http://...`,
              ...
              (0, A.jsx)(`div`, {
                ...
                children: (0, A.jsx)(Dn, {
                  ...
                  children: `Já tem conta? Voltar ao Login`,
                }),
              }),
            ],
          }),
...
var Ca = () =>
          ...
          children: [
            (0, A.jsx)(`li`, {
              ...
              children: (0, A.jsxs)(On, {
                className: ({ isActive: e }) =>
                  e ? `nav-link active fw-bold` : `nav-link`,
                to: `/dashboard`,
                children: [
                  (0, A.jsx)(`i`, { className: `bi bi-speedometer2 me-2` }),
                  ` Dashboard`,
                ],
              }),
            }),
            (0, A.jsx)(`li`, {
              ...
              children: (0, A.jsxs)(On, {
                ...
                to: `/leads`,
                children: [
                  (0, A.jsx)(`i`, { className: `bi bi-person-plus me-2` }),
                  ` Leads`,
                ],
              }),
            }),
            (0, A.jsx)(`li`, {
              ...
              children: (0, A.jsxs)(On, {
                ...
                to: `/clientes`,
                children: [
                  (0, A.jsx)(`i`, { className: `bi bi-people me-2` }),
                  ` Clientes`,
                ],
              }),
            }),
            (0, A.jsx)(`li`, {
              ...
              children: (0, A.jsxs)(On, {
                ...
                to: `/users`,
                children: [
                  (0, A.jsx)(`i`, { className: `bi bi-gear me-2` }),
                  ` Utilizadores`,
                ],
              }),
            }),
  ...
  wa = () => {
    let e = ot(),
      t = localStorage.getItem(`userName`) || `Utilizador`;
    return (0, A.jsxs)(`header`, {
      ...
      children: [
        ...
        (0, A.jsxs)(`div`, {
          className: `navbar-nav w-100 d-flex flex-row justify-content-end align-items-center px-3`,
          children: [
            (0, A.jsxs)(`span`, {
          ...
          children: [
            (0, A.jsxs)(`div`, {
              ...
              children: [
                ...
                ` CRM proj5 - Todos os direitos reservados.`,
              ],
            }),
            (0, A.jsxs)(`div`, {
              children: [
  ...
  Da = () => {
    let [e, t] = (0, _.useState)({
      ...
      r = async () => {
        ...
        try {
          let n = await fetch(`http://localhost:8080/LuisF-proj5/rest/leads`, {
            method: `GET`,
            headers: { Accept: `application/json`, token: e },
          });
          if (n.ok) {
            let e = await n.json();
            t((t) => ({
              ...t,
              novos: e.filter((e) => e.state === 1).length,
              analise: e.filter((e) => e.state === 2).length,
              propostas: e.filter((e) => e.state === 3).length,
              ganhos: e.filter((e) => e.state === 4).length,
              perdidos: e.filter((e) => e.state === 5).length,
              leads: e.length,
            }));
          }
          let r = await fetch(
            `http://localhost:8080/LuisF-proj5/rest/clients`,
            {
              method: `GET`,
              headers: { Accept: `application/json`, token: e },
            },
    ...
    return (
      ...
      (0, A.jsxs)(`div`, {
        ...
        children: [
          (0, A.jsx)(`div`, {
            className: `barra-welcome mb-4 p-3 bg-light rounded shadow-sm`,
            children: (0, A.jsx)(`h3`, {
              className: `m-0`,
              children: `Bem-vindo ao seu sistema CRM`,
            }),
          }),
          (0, A.jsx)(`div`, {
              ...
              (0, A.jsx)(
                `div`,
                {
                  ...
                  children: (0, A.jsxs)(`div`, {
                    ...
                    style: { backgroundColor: e.color, cursor: `pointer` },
                    onClick: () => n(e.route),
                    children: [
                      (0, A.jsx)(`div`, {
...
function Oa() {
  return (0, A.jsx)(wn, {
    basename: `/LuisF-proj5`,
    children: (0, A.jsxs)(Lt, {
      children: [
        (0, A.jsx)(Ft, { path: `/login`, element: (0, A.jsx)(ya, {}) }),
        (0, A.jsx)(Ft, { path: `/register`, element: (0, A.jsx)(Sa, {}) }),
        (0, A.jsxs)(Ft, {
          element: (0, A.jsx)(Ea, {}),
          children: [
            (0, A.jsx)(Ft, {
              path: `/`,
              element: (0, A.jsx)(Nt, { to: `/dashboard`, replace: !0 }),
            }),
            (0, A.jsx)(Ft, { path: `/dashboard`, element: (0, A.jsx)(Da, {}) }),
          ],
        }),
      ],
    }),
...
(0, g.createRoot)(document.getElementById(`root`)).render(
  (0, A.jsx)(_.StrictMode, { children: (0, A.jsx)(Oa, {}) }),
);
